...
namespace Compubuilt.Controllers
{
    public class ProductCategoriesController : Controller
    {
        ...
        public ProductCategoriesController(compubuiltContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.ProductCategories != null ? 
                          ...
                          Problem("Entity set 'compubuiltContext.ProductCategories'  is null.");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductCategoryId,ParentProductCategoryId,Name")] ProductCategory productCategory)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'compubuiltContext.ProductCategories'  is null.");
            }
            var productCategory = await _context.ProductCategories.FindAsync(id);
            if (productCategory != null)
            {
