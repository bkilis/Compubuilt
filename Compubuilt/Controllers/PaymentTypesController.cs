...
namespace Compubuilt.Controllers
{
    public class PaymentTypesController : Controller
    {
        ...
        public PaymentTypesController(compubuiltContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.PaymentTypes != null ? 
                          ...
                          Problem("Entity set 'compubuiltContext.PaymentTypes'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'compubuiltContext.PaymentTypes'  is null.");
            }
            var paymentType = await _context.PaymentTypes.FindAsync(id);
            if (paymentType != null)
            {
